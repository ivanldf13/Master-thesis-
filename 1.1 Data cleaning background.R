...
data.clean.no.punct <- Corpus  %>% 
  mutate(text = str_replace_all(text, "\\n", " "),
         ...
         text = str_replace_all(text, "(organi|moderni)\\s+(.|usa)?\\s+zation", "\\1zation"),
         ...
         text = str_replace_all(text, "(ac|ag|aq)\\spriations", "\\1priations"), 
         ...
         text = str_replace_all(text, "(adjust|equip)\\s\\b[pjo]\\b", "\\1"),
         ...
         text = str_replace_all(text, "([a-z]{1,12})\\s\\bment(s?)\\b", "\\1ment\\2"),
         ...
         text = str_replace_all(text, "([a-z]{0,9})\\s\\bcation(s?)\\b", "\\1cation\\2"),
         ...
         text = str_replace_all(text, "([a-z]{1,10})\\slation(s?)", "\\1lation\\2"),
         ...
         text = str_replace_all(text, "com\\sq", "com"),
         text = str_replace_all(text, "com\\smunit(y|ies)", "communit\\1"),
         ...
         text = str_replace_all(text, "adminis\\s>\\sj", "adminis"),
         
         text = str_replace_all(text, "([a-z]{2,9})\\s\\btration(s?)\\b", "\\1tration\\2"),
         ...
         text = str_replace_all(text, "([a-z]{2,10})\\s\\btural(s?)\\b", "\\1tural\\2"),
         ...
         text = str_replace_all(text, "([a-z]{1,11})\\s\\bation(s?)\\b", "\\1ation\\2"),
         ...
         text = str_replace_all(text, "([a-z]{1,10})\\s\\btation(s?)\\b", "\\1tation\\2"),
...
tokenised.no.punct <- data.clean.no.punct %>% 
  ...
  filter(!(words %in% c("york", "rockefeller", 1913:2013, 1:10, "rf", "univ", "Rf",
                        ...
                        "shall", "ok", "forl", "backi", "fas", "fss", "appro", "foundationorg",
                        "smns")))
...
#            words = str_replace_all(words, "(erice)(.*)", "ence\\2"),
#            words = str_replace_all(words, "(arice)(.*)", "ance\\2"),
#            words = str_replace_all(words, "approappropriation", "appropriation"),
#            words = str_replace_all(words, "approappropriations", "appropriations"),
#            words = str_replace_all(words, "approapproriations", "appropriations"),
#            words = str_replace_all(words, "adadministration", "administration"),
#            words = str_replace_all(words, "resilierice", "resilience"),
#            words = str_replace_all(words, "refererice", "reference"),
#            words = str_replace_all(words, "experierice", "experience"),
#            words = str_replace_all(words, "confererice", "conference"),
#            words = str_replace_all(words, "influerice", "influence"),
#            words = str_replace_all(words, "corresponderice", "correspondence"),
#            words = str_replace_all(words, "independerice", "independence"),
#            words = str_replace_all(words, "scierice", "science"),
#            words = str_replace_all(words, "scierices", "sciences"),
#            words = str_replace_all(words, "balarice", "balance"),
#            words = str_replace_all(words, "florerice", "florence"),
#            words = str_replace_all(words, "preserice", "presence"),
#            words = str_replace_all(words, "intracontmental", "intracontinental"),
