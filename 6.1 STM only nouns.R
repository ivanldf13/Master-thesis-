...
tibble(k = 5:20, exclus_nouns = exclus_nouns[,1], semcoh_nouns = semcoh_nouns[,1]) %>% 
  ...
  ggtitle("Figure 4: Number of topic suggested by Exclusivity and Semantic coherence")
...
plot(res10_nouns, type = "summary", topic.names = c("T1*: Goal-oriented programmes:", 
     ...
     labeltype = "frex", 
     n = 7,
     main = "Figure 6: Expected topic proportions")
...
gamma_nouns %>% 
  ...
  scale_fill_manual(values = c("#387fc7","#97bea1", "#e57272", "#e63cfe",
                    ...
                    name = "Topics") +
  ggtitle("Figure 7: Noun Topics and its correlation with time metadata") +
